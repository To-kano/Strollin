    ...
    return (
        <View>
          ...
          <View style={styles.infos}>
            <Text style={{fontSize: 30}}> Email: {json.Email} </Text>
            <Text style={{marginTop: '2%', fontSize: 30}}> Password: {json.Password} </Text>
            <Text style={{textAlign: 'center', marginTop: '2%', fontSize: 30,}}> Tags: {list} </Text>
          </View>
        </View>
    );
  }
