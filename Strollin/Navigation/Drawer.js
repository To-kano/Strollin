...
function MyDrawer() {
  return (
    ...
    >
      ...
      <Drawer.Screen name={I18n.t("Menu.positionPartener")} component={Position_partener} />
      <Drawer.Screen name={I18n.t("Menu.subscription")} component={Subscription} />
      <Drawer.Screen name={I18n.t("Menu.notation")} component={Notation} />
