    ...
    return (
      <View style={{ flex: 1 }}>
        <View style={[{ flex: 1 , backgroundColor : "white"}]}>
            <ImageBackground source={require('../../assets/login_image.jpg')} style={{ width: Dimensions.get('window').width, height: Dimensions.get('window').width / 1.8, justifyContent: "center" , flex:1}}>
              <View >
                <View style={[{ flexDirection: "row", justifyContent: "center"}]}>
                  <RondFormeText text="Strollin'" size={140} />
                </View>
                <View style={[{ backgroundColor: 'white', width: '120%', height: "32%", rotation: -5, display: "none"}]}/>
              </View>
            </ImageBackground>
        </View>
