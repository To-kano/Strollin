...
import {
  StyleSheet, Text, View, Button, PermissionsAndroid
} from 'react-native';
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <View style={{ flex: 0.5 }}>
          <Text style={{
            textAlign: 'center', fontSize: 30, fontFamily: 'lobster', color: '#EEB015', marginTop: 10
          }}
          >
            Strollin
          </Text>
        ...
        <View style={{
          flex: 1, marginTop: 50, backgroundColor: 'rgba(255,255,255, 0.9)', borderRadius: 0
        }}
        >
          <Text style={[{
        ...
        <View style={{
          flex: 0.4, flexDirection: 'row', justifyContent: 'space-around', paddingTop: 10, marginBottom: 10
        }}
        >
          <Button
            title="Another One!"
            color="#EEB015"
            onPress={() => this.getNewTrip(this.state.count, uid)}
          />
          <Button
            title="Let's go!"
            color="#89B3D9"
            onPress={() => this.props.navigation.navigate('TripNavigation', { region: this.state.region })}
          />
