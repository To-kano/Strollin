...
import styles from "./PartnerLoginArea.module.css";

function PartnerLoginArea() {
      ...
      <div className={styles.backgroundImage}>
        <div> 
          ...
          <div className={styles.row}>
              <h1 >Gain mor visibility with Strollin'!</h1>
              <h2 className={styles.row}>
              No need for plan anymore! Strollin, your new guide to free time!
              </h2>
          </div>
        </div>
      </div>
...
export default PartnerLoginArea;
