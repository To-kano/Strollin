...
import {
  StyleSheet, Text, View, Button, ImageBackground, ScrollView, TextInput, ActivityIndicator
} from 'react-native';
    ...
    return (
      <View style={[{ flex: 1 }]}>
        <View style={[{ flex: 1, marginBottom: '45%' }]}>
          ...
          <View style={[styles.container, {
            backgroundColor: 'white', width: '390%', height: '620%', rotation: -10, marginTop: -70, marginLeft: -10
          }]}
          />
